...
INPUT_DIRS: list[str] = []
INPUT_GLOB = "geodesic_evolutions/live_gui_*"
INPUT_DIR: str | None = None
OUTPUT_DIR = "geodesic_case_profiles"
B_SPLINE_METRICS_PATH = "geodesic_boxplots/geodesic_boxplot_all_metrics_summary.json"
...
def _is_valid_input_dir(path: Path) -> bool:
    return (
        path.is_dir()
        and (path / "path_evolution_snapshots.json").exists()
